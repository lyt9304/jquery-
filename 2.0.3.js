...
//IE8下可以修改undefined，传参的话，就可以防止去改变外部的undefined
//undefined不是保留字，可以当比那两名
//将window传参进去，作为局部变量可以提高搜索的效率
...
//在严格模式下不要去使用
    ...
    // A central reference to the root jQuery(document)
        rootjQuery,
        //为什么要这么赋值？（1）压缩版本可以变成一个字符，方便压缩；（2）方便理解
    ...
    // For `typeof xmlNode.method` instead of `xmlNode.method !== undefined`
        core_strundefined = typeof undefined,//得到字符串形式的"undefined"
        //如果直接判断，可能判断不出来，用typeof是兼容考虑IE9
    ...
    //jQuery就返回jQuery原型下的init
    //新建和初始化用一句就实现了，不用再去调用init函数
    ...
    //匹配浏览器私有属性-webkit-margin-left->webkitMarginLeft
    //例外IE->MsMarginLeft
        rmsPrefix = /^-ms-/,
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        //自动生成
        // function Aaa(){}
        // Aaa.prototype.constructor=Aaa;//可以修改，自动生成
        ...
        // var a1=new Aaa();
        // alert(a1.constructor)//后期添加，所以还是Aaa()
